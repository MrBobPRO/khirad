{{------------------------ Used only in authors.single route ------------------}}
<!DOCTYPE html>
...
<head>
   ...
   <title>Хирад | {{$author->name}}</title>
   <meta name="keywords" content="{{$author->name}}, книги, бесплатные книги, онлайн библиотека, купить книги в Таджикистане, читать книги онлайн"/>
