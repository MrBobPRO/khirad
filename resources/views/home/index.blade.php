         ...
         <div class="item" style="background-color: {{$book->bgColor}}; color: {{$book->txtColor}}">
            ...
            <div class="owl-item-inner">
               ...
               <div class="owl-img-container">
                  <img src="{{asset('img/books/' . $book->photo)}}" style="box-shadow: 0 0px 10px {{$book->bgColor}}">
               </div>
            </div>
         </div>
         @endforeach
         ...
         <div class="sidebar">
            ...
            @foreach ($discountedBooks as $book)
                <div class="sidebar-book-block">
                   <a class="sidebar-link" href="{{route('books.single', $book->id)}}"><img src="{{asset('img/books/' . $book->photo)}}"></a>
         ...
         @foreach ($topBooks as $topBook)
             <div class="top-book-singe">
                <a href="{{route('books.single', $topBook->id)}}">
                  <img src="{{asset('img/books/' . $topBook->photo)}}" style="box-shadow: 0px 0px 5px -2px {{$topBook->bgColor}};">
                  <h2>{{$topBook->name}}</h2>
                </a>
                <p>
